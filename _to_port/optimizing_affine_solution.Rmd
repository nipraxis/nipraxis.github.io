...
In Optimizing rotation exercise we used optimization to find what
...
are using Random numbers with np.random to give us samples from the standard normal
distribution:
...
We can pick up the subject data and template data from the :
...
side by side, using Subplots and axes in matplotlib:
