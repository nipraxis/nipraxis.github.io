...
We’ve previously had a look at the file `ds114_sub009_t2r1.nii`.
...
Download the [OpenFMRI](https://openfmri.org/) task definition file
`ds114_sub009_t2r1_cond.txt`. It comes from subject 9 task 2 and run
1 of the [ds114 dataset](https://openfmri.org/dataset/ds000114).
