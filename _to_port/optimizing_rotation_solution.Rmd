...
In the last exercise – Rotation exercise – you undid a
rotation.
...
can get that from code in the [optimizing space](https://matthew-brett.github.io/teaching/optimizing_space.html) page, and paste it below.
...
Our vector of rotations is length 3, containing the $r_x, r_y, r_z$,
...
Use the [global scope](http://matthew-brett.github.io/teaching/global_scope.html) to pick up and use `rotated_vol0` and `vol0` in
the function.
...
functions from [scipy.optimize](https://docs.scipy.org/doc/scipy/reference/tutorial/optimize.html).
